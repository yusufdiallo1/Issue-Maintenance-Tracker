...
export const T = {
  ...
  backOnline: { en: "Back online", ar: "عاد الاتصال" },
  syncing: { en: "Syncing…", ar: "جارٍ المزامنة…" },
  allSynced: { en: "All synced", ar: "تمت المزامنة" },
  pendingSync: { en: "Pending sync", ar: "بانتظار المزامنة" },
  showingSaved: { en: "Showing saved data", ar: "عرض البيانات المحفوظة" },
  signoutQ: { en: "Sign out?", ar: "تسجيل الخروج؟" },
  signoutMsg: {
  ...
  loadError: { en: "Couldn't load this — try again.", ar: "تعذّر التحميل — حاول مجددًا." },
  retry: { en: "Retry", ar: "إعادة المحاولة" },
  search: { en: "Search", ar: "بحث" },
  searchPh: { en: "Search room, description, or person…", ar: "ابحث عن غرفة أو وصف أو شخص…" },
  sortNewest: { en: "Newest", ar: "الأحدث" },
  sortUrgent: { en: "Most urgent", ar: "الأكثر إلحاحًا" },
  sortDeadline: { en: "Deadline", ar: "الموعد النهائي" },
  fAllProps: { en: "All", ar: "الكل" },
  noResults: { en: "No matching reports.", ar: "لا توجد بلاغات مطابقة." },
  ...
  youTook: { en: "You took this — mark as done?", ar: "أنت تولّيت هذا — وضعه كمكتمِل؟" },
  ...
  vRole: { en: "changed the role of", ar: "غيّر دور" },
  vPwreset: { en: "reset the password of", ar: "أعاد تعيين كلمة مرور" },
  // ---- Manage area ----
  navManage: { en: "Manage", ar: "الإدارة" },
  tabTeam: { en: "Team", ar: "الفريق" },
  tabAudit: { en: "Audit", ar: "السجل" },
  tabAnalytics: { en: "Analytics", ar: "التحليلات" },
  resetPw: { en: "Reset password", ar: "إعادة تعيين كلمة المرور" },
  newPassword: { en: "New password", ar: "كلمة مرور جديدة" },
  save: { en: "Save", ar: "حفظ" },
  cancel: { en: "Cancel", ar: "إلغاء" },
  remove: { en: "Remove", ar: "إزالة" },
  confirmRemove: { en: "Remove this employee?", ar: "إزالة هذا الموظف؟" },
  roleChanged: { en: "Role updated", ar: "تم تحديث الدور" },
  pwReset: { en: "Password reset", ar: "تمت إعادة تعيين كلمة المرور" },
  removed2: { en: "Employee removed", ar: "تمت إزالة الموظف" },
  actionFailed: { en: "Something went wrong.", ar: "حدث خطأ ما." },
  exportCsv: { en: "Export CSV", ar: "تصدير CSV" },
  downloadPdf: { en: "Download weekly PDF", ar: "تنزيل تقرير الأسبوع PDF" },
  timeToFix: { en: "Time to fix", ar: "زمن الإصلاح" },
  slaWithin: { en: "resolved within deadline", ar: "حُلّت ضمن الموعد النهائي" },
  repeatOffenders: { en: "Repeat offenders", ar: "مشاكل متكرّرة" },
  needsPermfix: { en: "needs a permanent fix", ar: "يحتاج إصلاحًا دائمًا" },
  trend: { en: "Trend (14 days)", ar: "الاتجاه (14 يومًا)" },
  trendCreated: { en: "Created", ar: "مُنشأة" },
  trendResolved: { en: "Resolved", ar: "محلولة" },
  byProperty: { en: "By property", ar: "حسب المبنى" },
  byCategory: { en: "By category", ar: "حسب النوع" },
  leaderboard: { en: "Leaderboard", ar: "لوحة الإنجاز" },
  jobsResolved: { en: "resolved", ar: "محلولة" },
  managerBrief: { en: "Manager brief", ar: "ملخص المدير" },
  noData: { en: "Not enough data yet.", ar: "لا توجد بيانات كافية بعد." },
  filterUser: { en: "User", ar: "المستخدم" },
  filterAction: { en: "Action", ar: "النشاط" },
  allUsers: { en: "All users", ar: "كل المستخدمين" },
  allActions: { en: "All actions", ar: "كل الأنشطة" },
  acReport: { en: "Reported", ar: "إبلاغ" },
  acTake: { en: "Took", ar: "تولّى" },
  acDone: { en: "Completed", ar: "إكمال" },
  acDeadline: { en: "Deadline", ar: "موعد نهائي" },
  acAddemp: { en: "Added employee", ar: "إضافة موظف" },
  acRmemp: { en: "Removed employee", ar: "إزالة موظف" },
  acLogin: { en: "Signed in", ar: "تسجيل دخول" },
  acRole: { en: "Role change", ar: "تغيير دور" },
  acPwreset: { en: "Password reset", ar: "إعادة تعيين كلمة المرور" },
  xTimesIn60d: {
